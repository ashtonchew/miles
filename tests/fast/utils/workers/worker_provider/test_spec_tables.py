...
from miles.utils.workers.worker_spec import BaseWorkerSpec, PortInfo
...
class TestRanksPerPod:
    ...
    def test_matches_the_number_of_ranks_the_launcher_supervises_in_one_pod(
        ...
        assert spec_tables.fleet_ranks_per_pod(specs=[spec], num_gpus_per_node=num_gpus_per_node) == {
    ...
    def test_an_engine_pod_runs_one_command_and_therefore_holds_one_rank(self) -> None:
        ...
        assert spec_tables.fleet_ranks_per_pod(specs=[spec], num_gpus_per_node=8) == {"engine": 1}
