    ...
    "miles-run": [
        *SHARED_INFRA_VARIANTS,
        ...
        [
            ...
            "--set",
            "run.colocate.engineFleet=e",
            "--set",
            "run.colocate.trainerFleet=t",
            "--set-json",
            'run.inferenceEngines=[{"name":"e","replicas":4,"command":["python"]}]',
            "--set-json",
            'run.trainers=[{"name":"t","replicas":2,"size":2,"command":["python"]}]',
        ],
    ],
}
